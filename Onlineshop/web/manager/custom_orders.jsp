                            ...
                            <form action="${pageContext.request.contextPath}/custom-orders" method="get" class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        ...
                                        <option value="8" ${status == '8' ? 'selected' : ''}>Đơn thiết kế đã từ chối</option>
                                        <option value="8" ${status == '9' ? 'selected' : ''}>Đơn thiết kế sẵn sàng giao</option>
                                    </select>
                                </div>
                        ...
                        <nav aria-label="Page navigation" class="mt-4">
                            <ul class="pagination justify-content-center">
                                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                    <a class="page-link" href="${pageContext.request.contextPath}/custom-orders?page=${currentPage - 1}&orderId=${orderId}&customerName=${customerName}&status=${status}" aria-label="Previous">
                                        <span aria-hidden="true"><i class="fas fa-chevron-left"></i></span>
                                    </a>
                                </li>

                                <c:forEach begin="1" end="${totalPages}" var="i">
                                    <li class="page-item ${currentPage == i ? 'active' : ''}"><a class="page-link" href="${pageContext.request.contextPath}/custom-orders?page=${i}&orderId=${orderId}&customerName=${customerName}&status=${status}">${i}</a></li>
                                    </c:forEach>

                                <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                    <a class="page-link" href="${pageContext.request.contextPath}/custom-orders?page=${currentPage + 1}&orderId=${orderId}&customerName=${customerName}&status=${status}" aria-label="Next">
