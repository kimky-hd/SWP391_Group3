...
<head>
    ...
    <style>
        ...
        .status-1 { background-color: #f8d7da; color: #721c24; } /* Chờ duyệt */
        .status-2 { background-color: #d4edda; color: #155724; } /* Đã duyệt và đóng gói */
        .status-3 { background-color: #fff3cd; color: #856404; } /* Đang vận chuyển */
        .status-4 { background-color: #cce5ff; color: #004085; } /* Đã giao hàng */
        .status-5 { background-color: #d1ecf1; color: #0c5460; } /* Đã thanh toán */
        .status-6 { background-color: #e2e3e5; color: #383d41; } /* Đã hủy */
        .status-7 { background-color: #c3e6cb; color: #155724; } /* Đã duyệt đơn thiết kế */
        .status-8 { background-color: #f5c6cb; color: #721c24; } /* Từ chối đơn thiết kế */
                                ...
                                <form id="updateStatusForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="statusId" name="statusId" required>
                                            ...
                                            <option value="7" ${customOrder.statusID == 7 ? 'selected' : ''}>Đã duyệt đơn hàng thiết kế riêng</option>
                                            <option value="8" ${customOrder.statusID == 8 ? 'selected' : ''}>Đơn hàng thiết kế riêng bị từ chối</option>
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#updateStatusBtn").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "${pageContext.request.contextPath}/manager/custom-orders",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
                        if (response.success) {
                            showToast("Thành công", response.message, "success");
                            // Cập nhật trạng thái hiển thị trên trang sau 1 giây
                            setTimeout(function() {
                                location.reload();
                            }, 1000);
                        } else {
