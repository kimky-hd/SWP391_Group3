...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="form-container">
                    ...
                    <div class="customer-info-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1">
                                    <c:choose>
                                        <c:when test="${not empty formData['username']}">${formData['username']}</c:when>
                                        <c:otherwise>${editUser.username}</c:otherwise>
                                    </c:choose>
                                </h4>
                                <p class="mb-0 opacity-75">ID: ${editUser.accountID}</p>
                            </div>
                        </div>
                    </div>
                </c:if>
                ...
                <div class="form-header">
                    <h2><i class="fas fa-edit text-primary me-2"></i>Chỉnh sửa thông tin khách hàng</h2>
                    <p class="text-muted mb-0">Cập nhật thông tin khách hàng trong hệ thống</p>
                </div>
                ...
                <c:if test="${not empty editUser}">
                    <form action="${pageContext.request.contextPath}/staff/customers" method="post" novalidate id="editCustomerForm">
                        <input type="hidden" name="action" value="update">
                        <input type="hidden" name="id" value="${editUser.accountID}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="username" 
                                       name="username" 
                                       value="${formData['username'] != null ? formData['username'] : editUser.username}"
                                       required
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" 
                                       ...
                                       id="email" 
                                       name="email" 
                                       value="${formData['email'] != null ? formData['email'] : editUser.email}"
                                       required
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="phone" 
                                       name="phone" 
                                       value="${formData['phone'] != null ? formData['phone'] : editUser.phone}"
                ...
                <c:if test="${empty editUser}">
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        Không tìm thấy thông tin khách hàng để chỉnh sửa.
                        <a href="${pageContext.request.contextPath}/staff/customers" class="alert-link">Quay lại danh sách</a>
                    </div>
                </c:if>
            </div>
        </div>
    ...
    <script>
        ...
        // Focus on first input when page loads (if no success message)
