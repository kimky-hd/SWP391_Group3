                    ...
                    <div class="row">
                        <div class="col-md-8">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="${not empty complaint.image}">
                                            <div class="mb-3">
                                                ...
                                                <img src="${pageContext.request.contextPath}/${complaint.image}" alt="Hình ảnh khiếu nại" class="complaint-image">
                                            </div>
                                        </c:if>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="${pageContext.request.contextPath}/staff/complaints" method="post">
                                            ...
                                            <div class="mb-3">
                                                <label for="status" class="form-label">Trạng thái sau khi phản hồi</label>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="card-body">
                                        <div class="d-grid gap-2">
                                            ...
                                            <a href="mailto:${userProfile.email}" class="btn btn-outline-secondary">
                                                <i class="fas fa-envelope me-2"></i>Gửi email: ${userProfile.email}
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="mb-0">Thông tin đơn hàng #${order.maHD}</h5>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <a href="${pageContext.request.contextPath}/staff/orders?action=view&id=${order.maHD}" class="btn btn-sm btn-info">
                                ...
                                <div class="card mt-3">
                                    <div class="card-header">
                                        <h5 class="mb-0">Mẫu phản hồi</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="list-group">
                                            <button type="button" class="list-group-item list-group-item-action" onclick="insertTemplate('Chào ${userProfile.fullName},\n\nChúng tôi đã nhận được khiếu nại của bạn và đang xem xét vấn đề này. Chúng tôi sẽ liên hệ lại với bạn trong thời gian sớm nhất.\n\nXin cảm ơn.')">Đang xử lý</button>
                                            <button type="button" class="list-group-item list-group-item-action" onclick="insertTemplate('Chào ${userProfile.fullName},\n\nChúng tôi xin lỗi về sự bất tiện này. Chúng tôi đã xác nhận vấn đề và sẽ tiến hành hoàn tiền cho bạn trong vòng 3-5 ngày làm việc.\n\nXin cảm ơn sự kiên nhẫn của bạn.')">Hoàn tiền</button>
                                            <button type="button" class="list-group-item list-group-item-action" onclick="insertTemplate('Chào ${userProfile.fullName},\n\nChúng tôi xin lỗi về sự cố này. Chúng tôi sẽ gửi sản phẩm thay thế cho bạn trong thời gian sớm nhất. Vui lòng giữ lại sản phẩm lỗi để đổi trả.\n\nXin cảm ơn.')">Đổi sản phẩm</button>
                                            <button type="button" class="list-group-item list-group-item-action" onclick="insertTemplate('Chào ${userProfile.fullName},\n\nCảm ơn bạn đã báo cáo vấn đề này. Chúng tôi đã xác nhận và đã giải quyết vấn đề của bạn. Nếu bạn có bất kỳ câu hỏi nào khác, vui lòng liên hệ với chúng tôi.\n\nTrân trọng.')">Đã giải quyết</button>
                                            <button type="button" class="list-group-item list-group-item-action" onclick="insertTemplate('Chào ${userProfile.fullName},\n\nSau khi xem xét kỹ lưỡng, chúng tôi không thể chấp nhận khiếu nại này vì lý do [lý do]. Nếu bạn cần thêm thông tin hoặc có bất kỳ câu hỏi nào, vui lòng liên hệ với chúng tôi.\n\nTrân trọng.')">Từ chối</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
